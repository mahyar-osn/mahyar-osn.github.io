...
$$
\epsilon\_x = \Sigma\_x^{-1} \left( x\_k - A f(\hat{x}\_{k-1}) - B u\_k \right)
$$
...
$$
\Delta A = \eta \epsilon\_x f(\hat{x}\_{k-1})^T
$$

$$
\Delta B = \eta \epsilon\_x u\_k^T
$$

$$
\Delta C = \eta \epsilon\_y f(x\_k)^T
$$
